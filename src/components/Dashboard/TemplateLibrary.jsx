    ...
    return (
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-md p-6"> 
            <div className="flex flex-col md:flex-row md:items-center justify-between mb-6">
                {/* Updated for dark mode */}
                <h3 className="text-xl font-bold text-gray-900 dark:text-gray-100 mb-4 md:mb-0">Template Library</h3>
                ...
                {categories.map(filter => (
                    <button
                        ...
                        className={`
                            ...
                            ${activeFilter === filter
                                // Active state is fine in both modes
                                ? 'bg-blue-600 text-white border-blue-600'
                                // Updated inactive state for dark mode
            ...
            {/* Loading/Error text updated for dark mode */}
